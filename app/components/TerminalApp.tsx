...
export default function TerminalApp({ onClose, isOpen }: TerminalAppProps) {
  ...
  const fileContents: Record<string, string[]> = {
    "~/resume.txt": [
      ...
      "==========================================",
      "",
      "📧 Contact: poojamanu567@gmail.com",
      "🔗 LinkedIn: linkedin.com/in/poojashree-k-s",
      "💻 GitHub: github.com/poojashree-ks",
      "",
    ...
    "~/about/whoami.txt": [
      ...
      "Specialization: Python Automation & Accessibility Testing",
      "",
      "A passionate software engineer with expertise in",
      "Python automation, accessibility compliance, and web development."
    ],
    "~/about/education.txt": [
      "🎓 EDUCATION",
      "============",
    ...
    "~/experience/cisco.txt": [
      ...
      "",
      "🔧 Responsibilities:",
      "• Developing automated accessibility testing tools using Python",
      "• Ensuring WCAG and Section 508 compliance for enterprise products", 
      "• Cross-functional collaboration with QA and product teams",
      "• Automation scripting and security compliance validation",
      "",
      "🏆 Achievements:",
      "• Implemented comprehensive accessibility testing suites",
      "• Improved compliance validation processes",
    ...
    "~/projects/library-management/README.md": [
      ...
      "• Admin dashboard",
      "",
      "🚀 GitHub: https://github.com/poojashree-ks/library-management"
    ],
    ...
    "~/contact/email.txt": [
      ...
      "================",
      "",
      "Primary: poojamanu567@gmail.com",
      "Personal: poojamanu567@gmail.com",
      "",
      "📝 Best for:",
      "• Job opportunities",
    ...
    "~/contact/linkedin.txt": [
      ...
      "===================",
      "",
      "Profile: linkedin.com/in/poojashree-k-s",
      "",
      "Connect with me for:",
      ...
      "• Knowledge sharing",
      "",
      "📈 Growing network in tech industry"
    ],
    "~/contact/github.txt": [
      "💻 GITHUB PROFILE",
      "==================",
      "",
      "Username: github.com/poojashree-ks",
      "",
      "📊 Stats:",
      "• Active contributor",
