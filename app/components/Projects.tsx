  ...
  const projects = [
    {
      ...
      description: 'Designed a wearable assistive device for real-time object detection, OCR-based text reading, obstacle alerts, and voice/tactile feedback to support visually impaired users. Features MobileNet SSD for object detection and TensorFlow for machine learning capabilities.',
      tech: ['IoT', 'Python', 'TensorFlow', 'MobileNet SSD', 'CNN', 'Raspberry Pi', 'OCR', 'TTS', 'Computer Vision', 'Assistive Technology'],
      image: '/api/placeholder/600/400',
      github: 'https://github.com/poojashree2001/Smart-glasses-project',
      live: '#',
      category: 'IoT/AI',
      icon: Bot,
    },
    {
      ...
      description: 'Developed a Flask-based web application to test websites for WCAG 2.1 AA compliance using axe-core and BeautifulSoup4 for HTML parsing. Integrated Selenium for cross-browser testing and real-time reporting with severity-based violation tagging and remediation suggestions.',
      tech: ['Python', 'Flask', 'Selenium', 'axe-core', 'BeautifulSoup4', 'WCAG 2.1', 'Accessibility Testing', 'Cross-browser Testing', 'HTML Parsing', 'Gunicorn'],
      image: '/api/placeholder/600/400',
      github: 'https://github.com/poojashree2001/WebAccTest',
      live: '#',
    ...
    },
    {
      ...
      image: '/api/placeholder/600/400',
      github: 'https://github.com/poojashree-ks/library-management-system',
