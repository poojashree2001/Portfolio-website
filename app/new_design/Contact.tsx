            ...
            <div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <a href="mailto:poojamanu567@gmail.com" className={`transition-colors ${isDarkMode ? 'text-gray-300 hover:text-white' : 'text-stone-600 hover:text-stone-800'}`}>
                    poojamanu567@gmail.com
                  </a>
                </div>
                <div>
                  <h4 className={`text-lg font-medium mb-2 transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-stone-800'}`}>Phone</h4>
                  <a href="tel:+919901002231" className={`transition-colors ${isDarkMode ? 'text-gray-300 hover:text-white' : 'text-stone-600 hover:text-stone-800'}`}>
                    +91-9901002231
                  </a>
                </div>
                <div>
                  <h4 className={`text-lg font-medium mb-2 transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-stone-800'}`}>Location</h4>
                  <p className={`transition-colors duration-300 ${isDarkMode ? 'text-gray-300' : 'text-stone-600'}`}>Bangalore, India</p>
                </div>
              </div>

              {/* Social Icons */}
              <div className="flex justify-center space-x-8 mt-12">
                <a href="https://linkedin.com/in/poojashree-k-s" target="_blank" rel="noopener noreferrer" className="group" title="LinkedIn Profile">
                ...
                <a href="https://github.com/poojashree-ks" target="_blank" rel="noopener noreferrer" className="group" title="GitHub Profile">
                ...
                <a href="mailto:poojamanu567@gmail.com" className="group" title="Email">
